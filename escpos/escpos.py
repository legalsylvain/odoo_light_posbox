...
try:
    ...
    jcconv = None
    print 'ESC/POS: please install jcconv for improved Japanese receipt'\
        'printing:'
    ...
    def text(self,txt):
        ...
        def encode_char(char):  
            ...
            if encoding != self.encoding:
                # if the encoding changed, remember it and prefix the character
                #  with the esc-pos encoding change sequence
